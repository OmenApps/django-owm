...
class WeatherLocation(OWM_BASE_MODEL):  # pylint: disable=R0903
    ...
    name = models.CharField(_("Location Name"), max_length=255, blank=True, null=True)
...
class WeatherData(OWM_BASE_MODEL):  # pylint: disable=R0903
...
class WeatherCondition(OWM_BASE_MODEL):  # pylint: disable=R0903
    ...
    class Meta(OWM_BASE_MODEL.Meta):  # pylint: disable=R0903
        """Meta options for the WeatherCondition model."""
        abstract = True


class CurrentWeather(WeatherData):  # pylint: disable=R0903
...
class HourlyWeather(WeatherData):  # pylint: disable=R0903
    ...
    rain_1h = models.DecimalField(_("Rain (1h)"), max_digits=5, decimal_places=2, blank=True, null=True)
    snow_1h = models.DecimalField(_("Snow (1h)"), max_digits=5, decimal_places=2, blank=True, null=True)
...
class DailyWeather(WeatherData):  # pylint: disable=R0903
    ...
    moon_phase = models.DecimalField(_("Moon Phase"), max_digits=5, decimal_places=2, blank=True, null=True)
    summary = models.TextField(blank=True, null=True)
    temp_min = models.DecimalField(_("Temperature Min"), max_digits=5, decimal_places=2, blank=True, null=True)
    temp_max = models.DecimalField(_("Temperature Max"), max_digits=5, decimal_places=2, blank=True, null=True)
    temp_morn = models.DecimalField(_("Morning Temperature"), max_digits=5, decimal_places=2, blank=True, null=True)
    temp_day = models.DecimalField(_("Day Temperature"), max_digits=5, decimal_places=2, blank=True, null=True)
    temp_eve = models.DecimalField(_("Evening Temperature"), max_digits=5, decimal_places=2, blank=True, null=True)
    temp_night = models.DecimalField(_("Night Temperature"), max_digits=5, decimal_places=2, blank=True, null=True)
    feels_like_morn = models.DecimalField(
        _("Feels Like - Morning"), max_digits=5, decimal_places=2, blank=True, null=True
    )
    feels_like_day = models.DecimalField(_("Feels Like - Day"), max_digits=5, decimal_places=2, blank=True, null=True)
    feels_like_eve = models.DecimalField(
        _("Feels Like - Evening"), max_digits=5, decimal_places=2, blank=True, null=True
    )
    feels_like_night = models.DecimalField(
        _("Feels Like - Night"), max_digits=5, decimal_places=2, blank=True, null=True
    )
    pop = models.DecimalField(_("Probability of Precipitation"), max_digits=5, decimal_places=2, blank=True, null=True)
    rain = models.DecimalField(_("Rain"), max_digits=5, decimal_places=2, blank=True, null=True)
    snow = models.DecimalField(_("Snow"), max_digits=5, decimal_places=2, blank=True, null=True)
